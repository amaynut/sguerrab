...
class listeCorrecteurs extends Common
{
	var $Editor;
		...
		?>
                    <div id="corps">
                       <?php include "menus/menu.php" // choisi le menu de l'utilisateur selon son type'?>
                        ...
                        <h1>Gestion des Correcteurs d'examens</h1>
                       <button style="display:block" onclick="self.location.href='ajouter-utilisateur.php?type=correcteur'"> Ajouter un correcteur d'examens
                           </button>
	...
	{
		$tableColumns['idCORRECTEUR'] = array('display_text' => 'Identifiant', 'perms' => 'TVQSXO');
		...
		$tableColumns['mail'] = array('display_text' => 'Email', 'perms' => 'EVCAXQSHO');
                ...
                $tableColumns['ville'] = array('display_text' => 'Ville', 'perms' => 'EVCAXQSHO');
                $tableColumns['pays'] = array('display_text' => 'Pays', 'perms' => 'EVCAXQSHO');

                $tableName = 'correcteurs';
		$primaryCol = 'idCORRECTEUR';
