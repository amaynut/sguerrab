...
<title>Gestion de Notes e-Miage: interface Responsable Pédagogique (RP)</title>
</head>
...
<body>
            ...
            <div id="corps">
               ...
               <h3> Bienvenue <?php echo $_SESSION['prenom'] . " ". $_SESSION['nom']; //Affichage du nom de la personne ?> </h3>       
				...
				$requeteCheminphoto = mysql_query ("SELECT photo FROM rp WHERE idRP = '$id'");
                ...
                <h1> Fiche Perso </h1>   
                 <?php 
                    ...
                    // rechercher les coordonnées du RP
                    $requeteCoordonnees= mysql_query("SELECT * FROM `rp` WHERE `idRP`= \"$id\"");
