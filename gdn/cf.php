...
<body>
            ...
            <div id="corps">
               ...
               <h3> Bienvenue <?php echo $_SESSION['prenom'] . " ". $_SESSION['nom']; //Affichage du nom de la personne ?> </h3>
				...
				$requeteCheminphoto = mysql_query ("SELECT photo FROM cf WHERE idCF= '$id'");
              ...
              <?php
                    ...
                    // rechercher les coordonnées du CF
                    $requeteCoordonnees= mysql_query("SELECT * FROM `cf` WHERE `idCF`= \"$id\"");
