...
<title>Gestion de Notes e-Miage: interface Tuteur de modules</title>
</head>
...
<body>
            ...
            <div id="corps">
                         <?php include "menus/menu-tuteur.php"?>
                 <div id="photo">
               <h3> Bienvenue <?php echo $_SESSION['prenom'] . " ". $_SESSION['nom']; //Affichage du nom de la personne ?> </h3>
				...
				$requeteCheminphoto = mysql_query ("SELECT photo FROM tuteurs WHERE idTUTEUR = '$id'");
                ...
                <h1> Fiche Perso </h1>
              <?php
                    // rechercher les coordonnées du tuteur
                    $requeteCoordonnees= mysql_query("SELECT * FROM `tuteurs` WHERE `idTUTEUR`= \"$id\"");
