...
class listeCf extends Common
{
		...
		?>
                    <div id="corps">
                       <?php include "menus/menu.php" // choisi le menu de l'utilisateur selon son type'?>
                        ...
                        <h1>Gestion des Coordinateurs de Formations </h1>
                       <button style="display:block" onclick="self.location.href='ajouter-utilisateur.php?type=cf'"> Ajouter un Coordinateur de Formation
                           </button>
	...
	{
		$tableColumns['idCF'] = array('display_text' => 'Identifiant', 'perms' => 'TVQSXO');
