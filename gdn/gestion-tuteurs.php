...
class listeTuteurs extends Common
{
	var $Editor;
		...
		?>
                    <div id="corps">
                        <?php include "menus/menu.php" // choisi le menu de l'utilisateur selon son type'?>
                         ...
                         <h1>Gestion des Tuteurs de modules</h1>
                         <p>
                            <button style="display:block" onclick="self.location.href='ajouter-utilisateur.php?type=tuteur'"> 
                                Ajouter un tuteur de modules
                           </button>
                         </p>
	...
	{
		$tableColumns['idTUTEUR'] = array('display_text' => 'IDENTIFIANT', 'perms' => 'TVQSXO');
		$tableColumns['nom'] = array('display_text' => 'NOM', 'perms' => 'EVCTAXQSHO');
		$tableColumns['prenom'] = array('display_text' => 'PRENOM', 'perms' => 'EVCTAXQSHO');
		$tableColumns['mail'] = array('display_text' => 'EMAIL', 'perms' => 'EVCAXQSHO');
                $tableColumns['phone'] = array('display_text' => 'TELEPHONE', 'perms' => 'EVCAXQSHO');
