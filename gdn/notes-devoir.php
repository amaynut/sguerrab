...
class notesDevoir extends Common
{
	var $Editor;
		...
		?>
                    <div id="corps">
                        ...
                        <p>
                           ...
                           <h1>Notes du devoir: </h1>
                           <?php
                                $devoir = mysql_query("SELECT * FROM devoirs WHERE idDEVOIR='$_POST[devoir]'")OR die (mysql_error());
                                $resultat = mysql_fetch_assoc($devoir);
                           ?>
                           <div style="text-align: center">
                               <p><strong>Module: </strong><?php echo $resultat['module']?> </p>
                               <p><strong>Session: </strong><?php echo htmlentities($resultat['session'])?>  </p>
                               <p><strong>Num&eacute;ro du devoir: </strong><?php echo $resultat['NUMERO']?></p>
                           </div>
			...
			<script type="text/javascript">
				trackHistory = false;
                                var ajaxUrl = '<?php echo $_SERVER['PHP_SELF']."?devoir=$_POST[devoir]"; ?>';
	...
	{
		$tableColumns['idNOTESDEVOIRS'] = array(
                    'display_text' =>
                    'ID', 'perms' => '');
		...
		$tableColumns['devoir'] = array(
                ...
                $tableName = 'notesdevoirs';
		$primaryCol = 'idNOTESDEVOIRS';
		...
		$this->Editor->setConfig('iconTitle','Op&eacute;ration');
                $this->Editor->setConfig('sqlFilters',"devoir='$_GET[devoir]'");
