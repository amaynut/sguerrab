...
class maxChart {
   ...
   function drawVertical(){
      ...
      foreach ($this->data as $key=>$value) {
	     ...
	     echo '    <div><img src="styleMaxChart/images/bar'.$color.'.png" style="width:'.$barw.'px; height:'.$a.'px;" /></div>'."\r\n";
   ...
   function drawHorizontal(){
      ...
      foreach ($this->data as $key=>$value) {
         ...
         echo '    <div class="barhimage"><img src="styleMaxChart/images/barh'.$color.'.png" style="width:'.$b.'px; height:'.$barh.'px;" /></div>'."\r\n";
