...
class LangVars
{
	...
	var $btnCSearch    = 'supprimer la recherche';
	...
	var $btnOrderCols  = 'Ordre des colonnes';
	...
	var $ttlNoRecord   = 'Ne trouve pas des lignes';
	var $lblSearch     = 'Rechercher';
	var $lblPage       = 'Page num&eacute;ro: ';
	var $lblDisplay    = 'Afficher ';
	var $lblMatch      = 'Correspondre: ';
	var $lblAllCrit    = 'Tous les crit&egrave;res';
	var $lblAnyCrit    = 'Un des crit&egrave;res';
